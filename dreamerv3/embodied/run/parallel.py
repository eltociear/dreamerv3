...
def actor(step, agent, replay, logger, actor_addr, args):
  # TODO: Use standalone tree map implementation.
...
def learner(step, agent, replay, logger, timer, args):
  ...
  if args.finetune_from:
    checkpoint.load(args.finetune_from)
